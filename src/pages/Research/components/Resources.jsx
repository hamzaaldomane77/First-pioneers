...
const servicesData = [
    ...
    {
      id: 3,
      image: Service1, // تأكد من وجود صورة هنا
...
export default function Resources() {
    ...
    return (
        <section className={`min-h-screen bg-cover bg-center transition-all duration-1000 p-6 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`} style={{ backgroundImage: `url(${Whitebackground})` }} ref={ref}>
            <h1 className="text-[#BB2632] text-5xl text-center pt-32 pb-20">Educational Resources</h1>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-10">
                {servicesData.slice(0, 3).map(service => (
                    <Link to={service.link} key={service.id} className="overflow-hidden shadow-lg rounded-lg transition-all duration-500 hover:scale-105 cursor-pointer group block">
                        ...
                        <div className="p-6 text-center">
                            ...
                            <Link to={service.link} className="text-[#BB2632] font-semibold relative inline-block pb-4 pr-6 pt-4 cursor-pointer">
                                View Article
            ...
            <div className='text-[#BB2632] text-center mt-8 p-12'>
                <Link to="" className="hover:text-[#BB2632] flex justify-center items-center gap-2 transition-all duration-500 group">
                    View All Resources
